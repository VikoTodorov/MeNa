...
<body class="background">
	...
	<nav class="navbar navbar-expand-sm bg-success navbar-dark fixed-bottom">
  		<ul class="navbar-nav">
    		...
    		<li class="nav-item">
      			<a class="nav-link active" href="pharmacy_reg.html">Pharmacy</a>
    		</li>
   			<li class="nav-item">
      			<a class="nav-link" href="doctor_reg.html">Doctor</a>
    		</li>
    		<li class="nav-item">
      			<a class="nav-link" href="signup.html">Patient</a>
    		</li>
  		</ul>
	</nav>
			...
			<div class="card-body">
				<form style= "text-align:center" action = "includes/login.inc.php" method ="post">
            		...
            		<div class="input-group form-group">
  							...
  							<input class="form-control" type="text" placeholder="Enter Special Code" name="SC" required><br>
  					</div>
			        <div class="input-group form-group">
  						<div class="input-group-prepend">
  							<span class="input-group-text"><i class="fas fa-key"></i></span>
  						</div>
 						<input class="form-control" type="text" placeholder="Enter address" name="address" required><br>
  					</div>
			        <div class="input-group form-group">
  						<div class="input-group-prepend">
  							<span class="input-group-text"><i class="fas fa-key"></i></span>
  						</div>
 						<input class="form-control" type="text" placeholder="Enter telephone" name="tel" required><br>
  					</div>
